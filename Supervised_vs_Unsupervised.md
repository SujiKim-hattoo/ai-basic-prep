...
* **Association Rules(연관 규칙)**
  ...
  * A rule-based methodfor findingrelationships between variables in a given dataset.
...
* Require large, diverse datasets to ensure accurate pattern recognition and predictions(as much as possible)
